                        ...
                        {savedBudgets.map((budget, index) => (
                            <div key={index} className="border rounded-lg p-4 bg-gray-50">
                                ...
                                <div className="mt-2 text-sm">
                                    <span className="font-medium">Servicios:</span> {budget.services.map(s => s.name).join(', ')}
                                </div>
                                ...
                                <div className="mt-1 font-medium">
                                    Total: ${budget.discountedTotal ? budget.discountedTotal.toFixed(2) : budget.total.toFixed(2)}
                                    {budget.discountedTotal && (
                                        <span className="text-sm text-gray-500 line-through ml-2">${budget.total.toFixed(2)}</span>
                                    )}
                                </div>
                                <div className="text-xs text-gray-500 mt-1">{budget.date}</div>
                            </div>
                        ))}
                    </div>
                </div>
