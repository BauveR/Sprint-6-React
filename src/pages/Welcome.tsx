            ...
            >
                ...
                >
                    ...
                    <motion.p 
                        ...
                        className="text-xl text-white mb-12 font-sans max-w-2xl mx-auto"
                    >
                        Crea presupuestos personalizados para tus proyectos web de manera rápida y sencilla
                    </motion.p>
                    ...
                    >
                        <Link
                            to="/presupuesto"
                            className="bg-gradient-to-r from-white to-cyan-200 text-blue-800 text-xl font-semibold py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all font-sans"
                        >
                            Comenzar
                        </Link>
                    </motion.div>
